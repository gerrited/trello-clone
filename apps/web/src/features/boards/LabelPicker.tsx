...
export function LabelPicker({ boardId, cardId, cardLabels, onToggle }: LabelPickerProps) {
  ...
  return (
    <div className="relative" ref={popoverRef}>
      ...
      {isOpen && (
        <div className="absolute z-50 top-full left-0 mt-1 w-72 bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden">
            ...
            <>
              ...
              <div className="max-h-56 overflow-y-auto p-2">
                {boardLabels.length === 0 ? (
                  <p className="text-sm text-gray-400 text-center py-3">Noch keine Labels vorhanden</p>
                ) : (
              ...
              <div className="p-2 border-t border-gray-100">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-1.5 text-sm text-gray-600 hover:bg-gray-50 rounded-md px-3 py-2 transition-colors"
                >
                  <Plus size={14} />
